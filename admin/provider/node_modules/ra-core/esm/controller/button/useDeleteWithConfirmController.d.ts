 ...
 * };
 */
declare const useDeleteWithConfirmController: ({ resource, record, redirect: redirectTo, basePath, onClick, }: UseDeleteWithConfirmControllerParams) => UseDeleteWithConfirmControllerReturn;
